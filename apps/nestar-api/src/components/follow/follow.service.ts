...
import { Follower, Followers, Following, Followings } from '../../libs/types/dto/follow/follow';
...
import { lookupAuthMemberLiked, lookupFollowerData, lookupFollowingData } from '../../libs/types/config';
