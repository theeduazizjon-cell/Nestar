...
import { AllBoardArticlesInquiry, BoardArticleInput, BoardArticlesInquiry } from '../../libs/types/dto/board-article/board-article.input';
...
export class BoardArticleService {
	...
	public async getBoardArticle(memberId: ObjectId, articleId: ObjectId): Promise<BoardArticle> {
		...
		targetBoardArticle.memberData = await this.memberService.getMember(null as unknown as ObjectId, targetBoardArticle.memberId);
